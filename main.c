...
// Define bitwise rotation operations
#define rotateleft(x,n) ((x<<n) | (x>>(32-n)))
#define rotateright(x,n) ((x>>n) | (x<<(32-n)))

// Function to compute SHA-1 hash
void FOO(unsigned char * str1)
{
    int i = 0;
    int j = 0;
    ...
    printf("\n\n");
    printf("FOO: %x %x %x %x %x", h0, h1, h2, h3, h4);
    printf("\n\n");
}
...
int main()
{
    FOO((unsigned char *)"The quick brown fox jumps over the lazy dog");
    return 0;
}
